' Description:
' __FB_OUT_OBJ__ indicates that the specified output file type on the compiler command line 
' at the time of compilation is an object module.
...
Declare Function Out_Obj () As Integer
